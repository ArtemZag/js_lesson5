...
var FilmService = function() {
    ...
    this.getFilm = function(id) {
        id = Number(id);
        return _.findWhere(this.FilmList, {
            id: id
        })
    };
    ...
    this.getFilmList = function(id) {
        if (id) {
            var item = _.findWhere(this.FilmList, {
                id: Number(id)
            });
            if (item) {
                return {
    ...
    this.deleteFilm = function(id) {
        this.FilmList = _.reject(this.FilmList, function(item) {
    ...
    this.updateFilm = function(item) {
        var film = _.findWhere(this.FilmList, {
            id: Number(item.id)
        });;
        var index = this.FilmList.indexOf(film);
        if (index > -1) {
            this.FilmList[index] = item;
        }
    }
